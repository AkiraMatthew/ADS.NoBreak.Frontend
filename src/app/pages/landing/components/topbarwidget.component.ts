...
@Component({
    ...
    template: `
            <img src="/src/assets/images/logo.png" style="width: 100px;" alt="">
        <a class="flex items-center" href="#">
            <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20">NoBreak</span>
        </a>
